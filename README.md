...
- Nettoyage et restructuration de bases de données électorales complexes
- Agrégation des partis politiques par grands bords idéologiques (gauche / centre / droite)
- Clustering (k-means) afin d’identifier des profils électoraux départementaux homogènes
- Analyse descriptive et comparative avec des variables socio-économiques (chômage, criminalité)
